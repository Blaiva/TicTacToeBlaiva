...
namespace TicTacToeBlaiva.Migrations
{
    ...
    [Migration("20250917152118_Creacion de la tabla Movimientos")]
    partial class CreaciondelatablaMovimientos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicTacToeBlaiva.Models.Movimientos", b =>
                {
            ...
            modelBuilder.Entity("TicTacToeBlaiva.Models.Partidas", b =>
                {
                    b.Property<int>("PartidaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TicTacToeBlaiva.Models.Movimientos", b =>
                {
                    b.HasOne("TicTacToeBlaiva.Models.Jugadores", "Jugador")
                        .WithMany("Movimientos")
                        .HasForeignKey("JugadorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TicTacToeBlaiva.Models.Partidas", "Partida")
                        .WithMany()
            ...
            modelBuilder.Entity("TicTacToeBlaiva.Models.Partidas", b =>
                {
                    b.HasOne("TicTacToeBlaiva.Models.Jugadores", "Ganador")
                        .WithMany()
                        .HasForeignKey("GanadorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TicTacToeBlaiva.Models.Jugadores", "Jugador1")
                        .WithMany()
                        .HasForeignKey("Jugador1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TicTacToeBlaiva.Models.Jugadores", "Jugador2")
                        .WithMany()
                        .HasForeignKey("Jugador2Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TicTacToeBlaiva.Models.Jugadores", "TurnoJugador")
                        .WithMany()
